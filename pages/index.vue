...
// Исправленный метод - принимает полную задачу, но передает только нужные данные
function updateTaskStatus(updatedTask: TaskDTO) {
  if (updatedTask.id) {
    store.update(updatedTask.id, { status: updatedTask.status })
  }
}
